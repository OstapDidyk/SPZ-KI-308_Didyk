...
class FileExplorerApp(QMainWindow):
    ...
    def displayProperties(self, path):
        result = file_explorer.displayFileProperties(path.encode('utf-8')).decode('utf-8')
        QMessageBox.information(self, "Properties", result)
